...
def create_overall_table
	...
	<table>
	<tr>
	<th>Overall Status</th><th>Total Test cases</th><th>HW Pass</th><th>HW Fail</th><th>HW Warn</th><th>HW Error</th><th>HW Remain</th>
	<th>RM Pass</th><th>RM Fail</th><th>RM Warn</th><th>RM Error</th><th>RM Remain</th><th>HW Pass percentage</th><th>RM Pass percentage</th>
	</tr>
	<tr>
...
def create_table(hw,rm,hash_data)
	test_area_values = hash_data[hw].keys
	arr= test_area_values.sort.to_a
	table_name = "<h2>"+rm+" and "+hw+"</h2>\n"
	$fileobject.write(table_name)
	hw_result = []
	rm_result = []
	table_start = "<table>"
	$fileobject.write(table_start)
	head = "<tr><th>Units</th><th>HW Total</th><th>HW Pass</th><th>HW Fail</th><th>HW Warn</th><th>HW Error</th><th>HW Remain</th><th>RM Pass</th><th>RM Fail</th><th>RM Warn</th><th>RM Error</th><th>RM Remain</th><th>HW Pass %</th><th>RM Pass %</th></tr>"
	...
	puts rm
	puts rm_total[1]/hw_total[0].to_f
...
$fileobject = File.new("Axe_to_html.html", "w");#opening the html page

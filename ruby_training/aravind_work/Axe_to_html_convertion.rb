...
if not true
	def AxeDownload
	   uri = URI('https://axeweb.intel.com/axe/api/testlist/306/latest/combined')
	   puts uri
...
def calculate_data(data_hash)
	calculate_overall_data('Compare','Render Fulsim',data_hash)
	#calculate_overall_data('2x4x8 Emulation Lockup','2x4x8 Rendermill',data_hash)
	calculate_overall_data('Lockup','Render',data_hash)
end
...
def create_execution_tables
	...
	create_table('Lockup','Render',$axe_data)
	create_table('Compare','Render Fulsim',$axe_data)
end

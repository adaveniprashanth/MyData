...
<td>Overall_Status</td><td>#{total_result[5]}</td><td>#{total_result[0]}</td><td>#{total_result[1]}</td><td>#{total_result[2]}</td><td>#{total_result[3]}</td><td>#{total_result[4]}</td><td style=\"background-color:\##{create_color_value(total_result)}\">#{((total_result[0]/total_result[5].to_f)*100).to_s[0..4]}%</td></tr>
</table><p></p>
"

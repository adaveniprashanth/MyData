...
'''
#https://indianxxx.rodeo/en/videos/malkin-uncut-hotx-originals-a-hindi-short-film.html
#video_url="https://indianxxx.rodeo/en/videos/malkin-uncut-hotx-originals-a-hindi-short-film.html"
video_url="https://video.u22577.eu.awmcdn.net/u022577/srv5406/storage26/c0/af/c09af2f68a4748ef3527a8a933a3aca6.mp4?URISigningPackage=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJBV01DRE4iLCJleHAiOjE3MTEyNjg5OTgsImNkbmlzdHQiOjEsImNkbmlldHMiOjkwLCJjZG5pdWMiOiJyZWdleDouKlwvdTAyMjU3N1wvc3J2NTQwNlwvc3RvcmFnZTI2XC9jMFwvYWZcL2MwOWFmMmY2OGE0NzQ4ZWYzNTI3YThhOTMzYTNhY2E2Lm1wNCJ9.siEyHaBtoLXDAQdNm9e9VP8pAL29nv1RkgrN7f4AOP4"
response = requests.get(video_url)
#print(response.content)

local_file_path = os.path.join('D:\\abc',f'sabc.mp4')
#local_file_path = os.path.join('D:\\abc',f'sabc.txt')
with open(local_file_path, 'wb') as video_file:
    video_file.write(response.content)
    
'''
def test(i,fp):
    video_url = f'http://ser2.desixclip.com/fl/2/{i}.mp4'
    #video_url = 'https://example.com/video.mp4'
    print(f"downloading the {i} file ")
    ...
    try:
        ...
        if response.status_code == 200:
            # Specify the local file path where you want to save the video
            #local_file_path = os.path.join('C:\\Users\\Windows 10\\Downloads\\ser2',f'{i}.mp4')
            #local_file_path = os.path.join(f'C:\\Users\\Windows 10\\Downloads\\ser2\\{i}.mp4')
            local_file_path = os.path.join('D:\\abc\\ser2',f'{i}.mp4')
